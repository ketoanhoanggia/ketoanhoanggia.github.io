				...
				$.ajax({
						...
						if (d == 'success') {
							if (noredirect) {
								...
								$jscontactresult
									.fadeIn('slow')
									.html(
										'<div class="mt-3 mb-0 alert alert-success text-center">' +
											success_msg +
											'</div>'
									)
									.delay(3000)
							...
							$jscontactresult
								.fadeIn('slow')
								.html(
									'<div class="mt-3 mb-0 alert alert-danger text-center">' + error_msg + '</div>'
								)
								.delay(3000)
								.fadeOut('slow');
							if (window.console) {
					...
					error: function (d) {
						$jscontactresult
							.fadeIn('slow')
							.html(
								'<div class="mt-3 mb-0 alert alert-danger text-center"> Cannot access Server</div>'
							)
							.delay(3000)
							.fadeOut('slow');
						$jscontactbtn.attr('disabled', false);
